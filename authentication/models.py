...
class Manager(BaseUserManager):
    ...
    def create_user(self, username, firstName, lastName,gender,role, phoneNumber, password):
        if not username:
    ...
    def create_superuser(self, username, password, phoneNumber, firstName = None,lastName = None, gender=None, role =None):
...
class User(AbstractBaseUser):
    ...
    role = models.CharField(choices=roles,   max_length=100, verbose_name="Role", blank=True)
    date_joined = models.DateTimeField(auto_now_add=True, verbose_name="date joined")
    last_login = models.DateTimeField(auto_now=True, verbose_name="last login")
